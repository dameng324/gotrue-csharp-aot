...
namespace Supabase.Gotrue
{
    ...
    public class AdminClient : IGotrueAdminClient<User>
    {
        ...
        public async Task<GenerateLinkResponse?> GenerateLink(GenerateLinkOptions options)
        {
            ...
            var result = JsonSerializer.Deserialize<GenerateLinkResponse>(
                response.Content,
                GotrueJsonContext.Default.GenerateLinkResponse
            );
            return result;
        }
        ...
        )
        {
            ...
            var result = JsonSerializer.Deserialize<List<Factor>>(
                response.Content,
                GotrueJsonContext.Default.ListFactor
            );
            var listFactorsResponse = new MfaAdminListFactorsResponse
            {
                Factors = result ?? new List<Factor>(),
            };
        ...
        ///
        /// </summary>
        /// <param name="deleteFactorParams"></param>
        /// <returns></returns>
