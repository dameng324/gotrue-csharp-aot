    ...
    public static class FailureHint
    {
        ...
        public static Reason DetectReason(GotrueException gte)
        {
            ...
            return gte.StatusCode switch
            {
                ...
                401 when gte.Content.Contains("This endpoint requires a Bearer token") =>
                    AdminTokenRequired,
                ...
                404 when gte.Content.Contains("No SSO provider assigned for this domain") =>
                    SsoDomainNotFound,
                ...
                422
                    when gte.Content.Contains(
                        "A user with this email address has already been registered"
                    ) => UserAlreadyRegistered,
                422 when gte.Content.Contains("Phone") && gte.Content.Contains("Email") =>
                    UserBadMultiple,
                422 when gte.Content.Contains("email") && gte.Content.Contains("password") =>
                    UserBadMultiple,
