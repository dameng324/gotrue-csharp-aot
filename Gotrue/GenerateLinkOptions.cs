...
namespace Supabase.Gotrue
{
    ...
    public class GenerateLinkSignupOptions : GenerateLinkOptions
    {
        ...
        /// </remarks>
        public GenerateLinkSignupOptions(string email, string password)
            : base(LinkType.SignUp, email)
        {
            Password = password;
        }
    }
    ...
    public class GenerateLinkEmailChangeCurrentOptions : GenerateLinkOptions
    {
        ...
        public GenerateLinkEmailChangeCurrentOptions(string email, string newEmail)
            : base(LinkType.EmailChangeCurrent, email)
        {
            NewEmail = newEmail;
        }
    }
    ...
    public class GenerateLinkEmailChangeNewOptions : GenerateLinkOptions
    {
        ...
        /// <param name="email"></param>
        /// <param name="newEmail"></param>
        public GenerateLinkEmailChangeNewOptions(string email, string newEmail)
            : base(LinkType.EmailChangeNew, email)
        {
            NewEmail = newEmail;
        }
    }
