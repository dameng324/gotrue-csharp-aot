...
namespace Supabase.Gotrue.Interfaces
{
        ...
        where TUser : User
    {
        ...
        /// </summary>
        /// <param name="listFactorsParams">A <see cref="MfaAdminListFactorsParams"/> object that contains the user id.</param>
        ...
        /// </summary>
        /// <param name="deleteFactorParams">A <see cref="MfaAdminListFactorsParams"/> object that contains the user id.</param>
