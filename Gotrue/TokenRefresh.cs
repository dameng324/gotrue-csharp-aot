...
namespace Supabase.Gotrue
{
    ...
    public class TokenRefresh
    {
        ...
        public void ManageAutoRefresh(
            IGotrueClient<User, Session> sender,
            Constants.AuthState stateChanged
        )
        {
            switch (stateChanged)
            {
                ...
                case MfaChallengeVerified:
                    ...
                    break;
                default:
                    throw new ArgumentOutOfRangeException(nameof(stateChanged), stateChanged, null);
            }
        }
        ...
        private TimeSpan GetSecondsUntilNextRefresh()
        {
            ...
            var secondsUntilNextRefresh = Convert.ToInt64(
                (refreshAt - DateTime.UtcNow).TotalSeconds
            );
